...
#ax_inset_l.set_xticks(np.arange(0, 10001, 2000))
ax_inset_l.set_xticks(np.arange(0, t.max(), 200))
ax_inset_l.tick_params(axis='both', which='major', length=8, width=1.5, right=True) 
